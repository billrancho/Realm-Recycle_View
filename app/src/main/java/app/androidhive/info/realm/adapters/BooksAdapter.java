...
import app.androidhive.info.realm.anim.CustomSlideDownAnimation;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        holder.card.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                holder.card.measure(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                CustomSlideDownAnimation customSlideDownAnimation = new CustomSlideDownAnimation(holder.card, 500, CustomSlideDownAnimation.COLLAPSE);
                customSlideDownAnimation.setHeight(targetHeight);
//                holder.setIsRecyclable(false);
                holder.card.startAnimation(customSlideDownAnimation);

                customSlideDownAnimation.setAnimationListener(new Animation.AnimationListener() {
                    @Override
